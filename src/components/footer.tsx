  ...
  return (
    <footer className="p-4 flex items-center justify-center">
      <nav className="flex sm:gap-12 gap-4">
        ...
        <a href="https://twitter.com/silviorodrigu3s" target="_blank" className="p-4 text-neutral-400">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
        ...
        <a href="https://github.com/silviorodrigues" target="_blank" className="p-4 text-neutral-400">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
